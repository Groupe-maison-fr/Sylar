...
const reducer = (previousState: LogListContextData, action: {type:string,payload:any}): LogListContextData => {
  switch (action.type) {
    case LOG_LIST_ACTIONS.ADD:
      previousState.list.unshift({ ...action.payload.logMessage, moment: moment(action.payload.logMessage.datetime) });
